import { createNewIndividualConversation } from '@peakee/api';
import { sendMessage } from '@peakee/api/websocket';
import { addMessage, resolveNewConversation, store } from '@peakee/state';
import type { Message } from '@peakee/types';
import { createRandomString } from '@peakee/utils';
